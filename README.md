...
- `cargo test --release --lib` → **1001 passed / 0 failed** (2026-08-09, TEXTURE + PRECEDENCE ship gate).
...
exponent of one ordered field) and `/v1/bundles/{name}/precedence` (which of
two fields moves first, read from record order rather than any clock).
